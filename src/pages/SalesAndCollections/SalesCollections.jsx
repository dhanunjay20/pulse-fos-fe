...
const SalesCollections = () => {
  ...
  useEffect(() => {
    axios
      .get("https://pulse-620964158368.asia-south2.run.app/products")
      .then((res) => {
  ...
  const handleProductChange = async (index, field, value) => {
    ...
    if (field === "productName") {
      ...
      if (selectedProduct) {
        ...
        try {
          const invRes = await axios.get("https://pulse-620964158368.asia-south2.run.app/inventory/latest");
    ...
    if ((field === "productName" || field === "gun") && row.productName && row.gun) {
      try {
        const res = await axios.get("https://pulse-620964158368.asia-south2.run.app/sales/last", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://pulse-620964158368.asia-south2.run.app/entryData", payload);
